...
sessions = [
    ...
    'start': '7.00', 'end': '9.00'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Monday',
    'start': '9.00', 'end': '12.20', 'details': 'Shared with school'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Monday',
    'start': '12.20', 'end': '13.20', 'details': u'♀'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Monday',
    'start': '13.20', 'end':'20.30'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Tuesday',
    'start': '7.00', 'end': '9.00'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Tuesday',
    'start': '9.00', 'end': '12.30', 'details': 'Shared with school'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Tuesday',
    'start': '12.30', 'end': '13.30'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Tuesday',
    'start': '13.30', 'end':'15.30', 'details': 'Shared with school'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Tuesday',
    ...
    'start': '12.30', 'end': '13.30'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Thursday',
    'start': '13.30', 'end':'19.30', 'details': 'Shared with school'},
    {'pool': 'York Hall Leisure Centre', 'day': 'Thursday',
    ...
    'end': '15.00', 'details': 'Shared with school'},
    ...
    'end': '18.00', 'details': 'Shared with fun swim'},
    ...
    'end': '17.00', 'details': 'Shared with fun swim'},
